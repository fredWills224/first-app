...
// Define [handlers]
                                ...
                                if(!err && userData){
                                    // Hash the sent [password], and compare it to the [password] stored in the [userData]
                                        ...
                                        if(hashedPassword == userData.hashedPassword){
                                            // if valid, create a new token with a random [tokenId]. Set expiration date to 1 hour in the future 
    ...
    // container for all the [handlers.checks]'s submethods
        ...
        // [handlers._checks.put]
            ...
            // Required [data] : [id], Optional [data] : [protocol, url, method, successCode, timeoutSeconds] (one must be sent)
                                                ...
                                                // Delete the [checkData]
                                                    _data.delete('checks', id, function(err){
                                                        ...
                                                        if(!err){
                                                            ...
                                                            // Look up the user by [checkData.userPhone]
                                                                _data.read('users', checkData.userPhone, function(err, userData){
                                                                    ...
                                                                    if(!err && userData){
                                                                        ...
                                                                        var userChecks = 
                                                                            ...
                                                                            // accept [checks] as valid array or set to empty array
                                                                        ;
                                                                        // Remove the deleted check from their list of checks [userChecks]
