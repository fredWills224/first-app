                ...
                handlers._checks.post = function(data, callback){
                    ...
                    // Validate inputs
                        var protocol =
                            ...
                            // must be of type string
                            // within this array the index of [protocol] should be greater than -1
                        ...
                        var method =
                            ...
                            // must be of type string
                            // within this array the index of [method] should be greater than -1
                                                        ...
                                                        // Save the object
                                                            _data.create('checks', checkId, checkObject, function(err){
                                                                ...
                                                                if(!err){
                                                                    ...
                                                                    // Add check to user's check list
                                                                    // Save user with user's new check list
